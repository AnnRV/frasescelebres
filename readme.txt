...
-------------------------------------------------------------------------------------------------------------
Las frases celebres estarán dentro de un array, en el documento frasescelebres.php

En programa escribiremos la función frasescelebres()
...
2.- Con las funciones rand() y cound() de php podemos variar la impresión del array
